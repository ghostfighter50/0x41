  ...
  fs.readdir('./commands/', async (err, files) => {
    ...
    totcmds = files.length;
      ...
      osutils.cpuUsage(function(v) {
        ...
        .addField("_____________________________________________________________________________","_____________________________________________________________________________",false)
