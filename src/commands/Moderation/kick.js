...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!message.guild.me.hasPermission('kick_MEMBERS')) { return message.reply('❌ I need permissions to kick!') }
    if (message.mentions.members.first().hasPermission('ADMINISTRATOR')) { return message.reply("❌ can't kick an Admin :p") }
