...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!message.guild.me.hasPermission('BAN_MEMBERS')) { return message.reply('❌ I need permissions to ban!') }
    if (message.mentions.members.first().hasPermission('ADMINISTRATOR')) { return message.reply("❌ can't ban an Admin :p") }
