module.exports = {
  ...
  run: async (client, message) => {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .addField(
        '**Levels**',
        client.serverconfig[message.guild.id].Levels ? client.serverconfig[message.guild.id].Levels : 'false',
        true
      )
      .addField('**Level Roles**', '**`sudo  levels`**', true)
      .addField(
        '**Anti-Skid Verification **',
        client.serverconfig[message.guild.id].SkidVerification ? client.serverconfig[message.guild.id].SkidVerification : 'false',
        true
      )
      .addField(
        '**Join Logger **',
        client.serverconfig[message.guild.id].JoinLogger ? client.serverconfig[message.guild.id].JoinLogger : 'false',
        true
      )
      .addField(
        '**Raid Mode **',
        client.serverconfig[message.guild.id].RaidMode ? client.serverconfig[message.guild.id].RaidMode : 'false',
        true
      )
      ...
      .addField(
        '**Join Message **',
        client.serverconfig[message.guild.id].JoinMessage ? client.serverconfig[message.guild.id].JoinMessage : 'none',
        true
      )
      .addField(
        '**Leave Message **',
        client.serverconfig[message.guild.id].LeaveMessage ? client.serverconfig[message.guild.id].LeaveMessage : 'none',
        true
      )
      .addField(
        '**Embed color **',
        client.serverconfig[message.guild.id].EmbedColor ? client.serverconfig[message.guild.id].EmbedColor : 'none',
        true
      )
      .setTitle('📖 Config ')
