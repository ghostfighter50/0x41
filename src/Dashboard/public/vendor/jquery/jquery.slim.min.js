...
!(function (e, t) {
  ...
  w.extend({
    ...
    map: function (e, t, n) {
      ...
      const u = []
      if (T(e)) {
        for (r = e.length; o < r; o++) { (i = t(e[o], o, n)) != null && u.push(i) }
  ...
  const E = (function (e) {
    ...
    (oe.attr = function (e, t) {
      ...
      let o = i && D.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !g) : void 0
      return void 0 !== o
        ? o
        : n.attributes || !g
          ? e.getAttribute(t)
    ...
    function me (e, t, n) {
      ...
      return t.first
        ...
        : function (t, n, s) {
          ...
          const d = [C, u]
          if (s) {
            while ((t = t[r])) { if ((t.nodeType === 1 || a) && e(t, n, s)) return !0 }
          } else {
            while ((t = t[r])) {
              if (t.nodeType === 1 || a) {
                if (
    ...
    function we (e, t, n, r, i) {
      for (var o, a = [], u = 0, s = e.length, l = t != null; u < s; u++) { (o = e[u]) && ((n && !n(o, r, i)) || (a.push(o), l && t.push(u))) }
      return a
    }
  ...
  w.fn.extend({
    ...
    is: function (e) {
      return !!L(this, typeof e === 'string' && A.test(e) ? w(e) : e || [], !1)
        .length
    }
  })
  let j
  ...
  function ye (e, t) {
    for (let n = 0, r = e.length; n < r; n++) { K.set(e[n], 'globalEval', !t || K.get(t[n], 'globalEval')) }
  }
  const me = /<|&#?\w+;/
  ...
  (w.event = {
    ...
    special: {
      ...
      click: {
        trigger: function () {
          if (this.type === 'checkbox' && this.click && D(this, 'input')) { return this.click(), !1 }
        },
        _default: function (e) {
          return D(e.target, 'a')
        }
  ...
  w.fn.extend({
    ...
    empty: function () {
      for (var e, t = 0; (e = this[t]) != null; t++) { e.nodeType === 1 && (w.cleanData(ve(e, !1)), (e.textContent = '')) }
      return this
    },
    clone: function (e, t) {
      return (
