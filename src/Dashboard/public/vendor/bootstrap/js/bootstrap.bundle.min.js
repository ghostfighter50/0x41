					...
					return (
						...
						(t._setActiveIndicatorElement = function (t) {
							if (this._indicatorsElement) {
								...
								const e = this._indicatorsElement.children[
		...
		(ii = (function () {
			...
			return (
				(t.refresh = function () {
					const e = this;
					const t =
						this._scrollElement === this._scrollElement.window ? ei : ni;
				...
				(t._getConfig = function (t) {
					if (
						typeof (t = c({}, zn, typeof t === "object" && t ? t : {}))
							.target !== "string"
					) {
